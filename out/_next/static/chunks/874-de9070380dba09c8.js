  ...
  [874],
  {
    ...
    6874: (e, t, r) => {
      ...
      let h = u.default.forwardRef(function (e, t) {
        ...
        let N = u.default.useContext(i.AppRouterContext),
          T = !1 !== g,
          S = null === g ? s.PrefetchKind.AUTO : s.PrefetchKind.FULL,
          { href: x, as: A } = u.default.useMemo(() => {
            let e = d(a);
            return { href: e, as: h ? d(h) : e };
          }, [a, h]);
        j && (n = u.default.Children.only(r));
        let k = j ? n && 'object' == typeof n && n.ref : t,
          w = u.default.useCallback(
            (e) => (
              T && null !== N && (0, p.mountLinkInstance)(e, x, N, S),
              () => {
        ...
        return (
          (0, l.isAbsoluteUrl)(A)
            ? (M.href = A)
            : (j && !m && ('a' !== n.type || 'href' in n.props)) ||
              (M.href = (0, c.addBasePath)(A)),
          j
            ? u.default.cloneElement(n, M)
            : (0, o.jsx)('a', { ...C, ...M, children: r })
        );
      });
