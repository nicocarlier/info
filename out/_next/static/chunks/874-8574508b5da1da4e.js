  ...
  [874],
  {
    ...
    6874: (e, t, n) => {
      ...
      let h = u.default.forwardRef(function (e, t) {
        ...
        let N = u.default.useContext(a.AppRouterContext),
          T = !1 !== g,
          S = null === g ? i.PrefetchKind.AUTO : i.PrefetchKind.FULL,
          { href: M, as: x } = u.default.useMemo(() => {
            let e = d(l);
            return { href: e, as: h ? d(h) : e };
          }, [l, h]);
        j && (r = u.default.Children.only(n));
        let k = j ? r && 'object' == typeof r && r.ref : t,
          A = u.default.useCallback(
            (e) => (
              T && null !== N && (0, p.mountLinkInstance)(e, M, N, S),
              () => {
          ...
          w = {
            ...
            onMouseEnter(e) {
              j || 'function' != typeof v || v(e),
                ...
                N && T && (0, p.onNavigationIntent)(e.currentTarget);
            },
        ...
        return (
          (0, s.isAbsoluteUrl)(x)
            ? (w.href = x)
            : (j && !m && ('a' !== r.type || 'href' in r.props)) ||
              (w.href = (0, c.addBasePath)(x)),
          j
            ? u.default.cloneElement(r, w)
            : (0, o.jsx)('a', { ...C, ...w, children: n })
        );
      });
      ('function' == typeof t.default ||
        ('object' == typeof t.default && null !== t.default)) &&
